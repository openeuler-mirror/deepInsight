...
export default {
  ...
  w3_auth_url: `${api_host}/w3/w3_auth_url`,
  ...
  getAsk: `${api_host}/dialog/get-ask`,
  getResearchDialog: `${api_host}/dialog/get-research`,
  downloadReport: `${api_host}/deepinsight/download_pdf`,
  setConversation: `/api/conversation`,
  getConversation: `/api/conversations`,
  getConversationSSE: `${api_host}/conversation/getsse`,
  generatePptConversationSSE: `${api_host}/conversation/generate_ppt_sse`,
  listConversation: `/api/conversations`,
  removeConversation: `/api/conversation`,
  completeConversation: `${api_host}/conversation/completion`,
  chat: `/api/chat`,
  deepResearchConversation: `${api_host}/conversation/deep_research`,
  questionConversation: `${api_host}/conversation/question`,
