...
<ul>
  ...
  <li>The auto-keyword feature is dependent on the LLM and consumes a significant number of tokens.</li>
    ...
    message: {
      ...
      hint: 'hint',
      reflecting: 'reflection process',
      executePlan: '执行流程',
      executeTools: 'execute tools',
      pptGenerateSucceed: 'ppt generate succeed',
      pptGenerateFailed: 'ppt generate failed',
      generatedFiles: 'generated files',
      referenceFrom: 'reference from',
      pptGenerating: 'generating ppt',
      pptGenerate: 'generate ppt',
      deepinsight: 'deepinsight',
    },
    fileManager: {
      name: 'Name',
